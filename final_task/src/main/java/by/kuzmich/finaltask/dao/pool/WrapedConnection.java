...
public class WrapedConnection implements Connection, Comparable <WrapedConnection>{
    private Connection connection;

    public WrapedConnection(Connection connection) {
    ...
    @Override
    public int compareTo(WrapedConnection connection) {
